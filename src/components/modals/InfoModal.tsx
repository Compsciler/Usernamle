  ...
  return (
    <BaseModal title="How to play" isOpen={isOpen} handleClose={handleClose} isWide={true}>
      <p className="text-sm text-gray-500 dark:text-gray-300">
        Guess the username in 8 tries. After each guess, the color of the tiles will
      ...
      <p className="text-sm text-gray-500 dark:text-gray-300">
        ...
        The username comes from one of the 10,000 top commenters on Reddit (as of November 2017). 
      ...
      <p className="text-sm text-gray-500 dark:text-gray-300">
        ...
        and the ones in the guess are both in the wrong spots.
      </p>
